    ...
    private void addEditViewChanged(EditText paramEditText, final View layout) {
        paramEditText.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable param1Editable) {
                ...
                EditText editText7 = layout.findViewById(R.id.textView_bfp_5kg_ys);
                EditText editText8 = layout.findViewById(R.id.textView_bfp_15kg_ys);
                EditText editText9 = layout.findViewById(R.id.textView_bfp_50kg_ys);
...
//        finish();
    ...
    private boolean judgeBottle() {
        try {
            ...
            Logger.e("空瓶和重瓶数量: "+"15KG "+size15);
            Logger.e("空瓶和重瓶数量: "+"50KG "+size50);
            //没有回收的瓶子数量
            Logger.e("处理空瓶》》》》");
            ...
            Logger.e("空瓶误差: "+"5KG "+size5);
            Logger.e("空瓶误差: "+"15KG "+size15);
            Logger.e("空瓶误差: "+"50KG "+size50);
            Logger.e("处理重瓶》》》》");
