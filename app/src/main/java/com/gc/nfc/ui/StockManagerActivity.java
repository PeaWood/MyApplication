...
public class StockManagerActivity extends BaseActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
        ...
        getServer(new Netcallback() {
            public void preccess(Object param1Object, boolean param1Boolean) {
                if (param1Boolean) {
                    ...
                    Toast.makeText(StockManagerActivity.this, "请求超时，请检查网络", Toast.LENGTH_LONG).show();
                    return;
                }
                Toast.makeText(StockManagerActivity.this, "网络未连接！", Toast.LENGTH_LONG).show();
            }
        }, netRequestConstant);
    }
                    ...
                    if (httpResponse != null) {
                        ...
                        if (httpResponse.getStatusLine().getStatusCode() == 200) {
                            try {
                                ...
                                Toast.makeText(StockManagerActivity.this, "异常" + iOException.toString(), Toast.LENGTH_LONG).show();
                            } catch (JSONException jSONException) {
                                Toast.makeText(StockManagerActivity.this, "异常" + jSONException.toString(), Toast.LENGTH_LONG).show();
                            }
                            return;
                        }
    ...
    private void refleshBottlesListZP() {
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, arrayList, R.layout.bottle_list_items, new String[]{"bottleCode"}, new int[]{R.id.items_spec});
    ...
    private void showBottleInfo(final String bottleCode, String paramString2, String paramString3, final String nextStatus) {
        ...
        AlertDialog.Builder builder = (new AlertDialog.Builder(this)).setTitle("返回结果").setIcon(R.drawable.icon_logo).setView(layout).setPositiveButton("确定", null).setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface param1DialogInterface, int param1Int) {
                Toast.makeText(StockManagerActivity.this, "强制交接！", Toast.LENGTH_LONG).show();
        ...
        dialog.getButton(-1).setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
                ...
                MediaPlayer.create(StockManagerActivity.this, R.raw.alarm).start();
    ...
    private void showScrapBottleInfo(String paramString1, String paramString2) {
        ...
        textView2.setText(paramString2);
        AlertDialog.Builder builder = (new AlertDialog.Builder(this)).setTitle("报废钢瓶").setIcon(R.drawable.icon_bottle).setView(view).setPositiveButton("确定", null);
        builder.setCancelable(false);
                    ...
                    if (param1Object != null) {
                        if (response.getStatusLine().getStatusCode() == 200) {
                            try {
                                ...
                                Toast.makeText(StockManagerActivity.this, "无效账户！", Toast.LENGTH_LONG).show();
    ...
    public boolean dispatchKeyEvent(KeyEvent paramKeyEvent) {
        if (paramKeyEvent.getKeyCode() == 4 && paramKeyEvent.getRepeatCount() == 0 && paramKeyEvent.getAction() == 0) {
            (new AlertDialog.Builder(this)).setTitle("提示").setMessage("确认退出吗？").setIcon(R.drawable.icon_logo).setPositiveButton("确定", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface param1DialogInterface, int param1Int) {
                    ...
                    if (param1Object != null) {
                        if (response.getStatusLine().getStatusCode() == 200)
                            try {
                                ...
                                Date date1 = new Date();
                                JSONObject serviceStatus = items.getJSONObject("serviceStatus");
                                if (date1.after(date2)) {
                                    ...
                                    DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface param2DialogInterface, int param2Int) {
                                            if (Tools.isFastClick())
                                                try {
                                                    if (serviceStatus.getInt("index") == 6 && nextStatus.equals("2")) {
                                    ...
                                    AlertDialog.Builder builder1 = builder.setPositiveButton("确定", onClickListener);
    ...
    public void onClick(View paramView) {
        ...
        switch (paramView.getId()) {
            case R.id.imageView_search_weightDevice:
            ...
            case R.id.imageView_addZPManual:
                ...
                if (m_selected_nfc_model == 0) {
                    ...
                    if (m_curLoginUserId.getGroupCode().equals("00005")) {
                        ...
                        Toast.makeText(this, "非充气站或门店账户，请退出！", Toast.LENGTH_LONG).show();
                    }
                    judgeBottleScrap(str, str1);
