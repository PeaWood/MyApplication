...
import com.dk.bleNfc.card.Type4Tag;
...
//                if (iso14443bCard != null) {
//                    msgBuffer.delete(0, msgBuffer.length());
//                    msgBuffer.append("寻到ISO14443-B卡\r\n");
//                    handler.sendEmptyMessage(0);
//                    //获取NDEF数据的指令流
//                    final byte[][] sfzCmdBytes = {
...
//                        try {
                            textRecord = Ntag21x.createTextRecord(writeText);//new NdefRecord(NdefRecord.TNF_WELL_KNOWN, NdefRecord.RTD_TEXT, new byte[] {}, ("zh" + writeText).getBytes("UTF-8"));
//                        } catch (UnsupportedEncodingException e) {
//                            e.printStackTrace();
//                        }
                        NdefMessage writeNdefMessage = new NdefMessage(new NdefRecord[] {textRecord});
...
//                        try {
//                            if (i % 4 == 0) {
//                                anth = mifare.authenticate((byte) i, Mifare.MIFARE_KEY_TYPE_B, key);
//                            }
//                            if (anth) {
//                                handler.sendEmptyMessage(0);
